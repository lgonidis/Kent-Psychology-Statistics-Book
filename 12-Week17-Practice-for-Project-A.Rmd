...
---
# Lab Session 8 (Week 17) {-}


## The aims of today's session

The aims of today's session are to prepare you for the analysis you will have to do for Project A. For this we will use a dummy datafile, and not the actual Project A datafile. This is because we want you to practice the work and then apply it to Project A.   
