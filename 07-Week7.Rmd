...
1. Open RStudio  
2. Create a new Project. **File > New Project > New Directory > New Project Then click on Browse and select your Desktop, for Directory Name type in Week 15 Lab. Then click on Create Project.**  
3. Go on moodle on the PSYC3000 page, in Week 15. In the lab section there are two files, **internet.csv** and **exercisew7.csv**. Download both files and save them or copy them in your **Week 15 Lab** folder that is on your desktop. **IF YOU ARE A MAC USER PLEASE USE CHROME AND NOT SAFARI.**  
...
5. Create a new script and save it as **week15**. Then type in the following commands and run them.  
