...
>>>>>>> 3c88c2b13fc24e69cbb1fe50b8ce7e6536ae5df9
...
=======
1. All correlation coeeficients between all your four variable as well as the *p-values*. hese should be reported in a table that will be formatted according to the American Psychological Association guidelines (APA 7). This should go in your results section
2.  We also want to see the scatterplots for all variable combinations (the four you chose). These should go in the Appendices. 
