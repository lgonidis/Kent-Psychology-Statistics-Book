...
---
# Workshop Session 3 (Week 18) {-}


## The aims of today's session

The aim of today's session is to guide you through the analysis you will have to do for Project A. For this we will use a dummy datafile, and not the actual Project A datafile. This is because we want you to practice the work and then apply it to Project A.   

Today you will practice mainly **four tasks**.  

1. Calculate the overall score for two questionnaires  
2. Draw a histogram for each of the two overall scores  
3. Create a scatterplot for the two overall scores  
